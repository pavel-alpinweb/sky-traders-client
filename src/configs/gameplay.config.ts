...
export const whaleParams = {
    ...
    description:
        ...
        "<p>&nbsp;</p>\n" +
        "<p>К сожалению, корабль унаследовал от прародителя и его неповоротливость, однако этот недостаток легко нивелируется огромной скоростью корабля.</p>\n" +
        "<p>&nbsp;</p>\n" +
        "<p>Такие значительные улучшения серьёзно увеличили стоимость корабля, сделав его недоступной мечтой для большинства торговцев.&nbsp;</p>\n",
    name: "Небесный кит",
}
