        ...
        towns: [
            ...
            },
            {
                ...
                description:
                    ...
                    "<p>&nbsp;</p>\n" +
                    '<p>Флот королевства состоит в основном из кораблей модели <b style="color:#23628e;"><strong>“Наглый альбатрос”</strong></b>, и не может справться с большим количеством <b style="color:#474c5e;"><strong>пиратов</strong></b>. Поэтому как рядом с городом, так и на пути к <b style="color:#4CAF50;"><strong>Брайвилю</strong></b>, их достаточно много.</p>\n',
            },
            {
                id: "final-01",
                name: "Нордвиль",
                ...
                description:
                    ...
                    "<p>&nbsp;</p>\n" +
                    '<p>В городе только начинают добычу полезных ископаемых, ведь поселение очень молодое. <b style="color:#3E2723;"><strong>Порох</strong></b>, <b style="color:#607D8B;"><strong>сталь</strong></b> и <b style="color:#000000;"><strong>уголь</strong></b> город пока вынужден закупать из <b style="color:#E65100;"><strong>Южного Кита</strong></b>.&nbsp;</p>\n' +
                    "<p>&nbsp;</p>\n" +
                    '<p>Для торговли с другими городами инженеры <b style="color:#BF360C;"><strong>Нордвиля</strong></b> создали мощный корабль модели <b style="color:#febe0c;"><strong>“Золотой пеликан”</strong></b>. На этом корабле можно добраться в любой уголок в Небесах Трех Дорог. Серьезные характеристики корабля заставляют <b style="color:#474c5e;"><strong>пиратов</strong></b> держаться от Глиняных гор на почтительном расстоянии.&nbsp;</p>\n',
            },
            {
                id: "final-02",
                name: "Южный кит",
